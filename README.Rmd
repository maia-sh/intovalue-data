...
| PubMed                            | Bibliometric                  | `r get_latest_query("PubMed", query_logs)`         | Zenodo                                                                                                                    | [get-pubmed.R](https://github.com/maia-sh/intovalue-data/blob/main/scripts/02_get-pubmed.R)                       |
| ClinicalTrials.gov/ AACT          | Registry                      | `r get_latest_query("AACT", query_logs)`           | Zenodo                                                                                                                    | [get-aact.R](https://github.com/maia-sh/intovalue-data/blob/main/scripts/06_get-aact.R)                           |
| DRKS                              | Registry                      | `r get_latest_query("DRKS", query_logs)`           | Zenodo                                                                                                                    | [get-drks.R](https://github.com/maia-sh/intovalue-data/blob/main/scripts/08_get-drks.R)                           |
